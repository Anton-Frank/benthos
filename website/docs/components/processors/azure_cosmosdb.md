...
azure_cosmosdb:
  ...
  partition_keys: [] # No default (required)
  operation: Create
...
Partition key values. Only string, integer and boolean values are supported. The partition key value type is deduced automatically when using interpolation.
